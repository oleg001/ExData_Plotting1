...
png(file="R:/ExData_Plotting1/plot4.png")
par(mfrow=c(2,2))
plot(train2$Date2,train2$Global_active_power,type="l",xlab="",ylab="Global Active Power")
plot(train2$Date2,train2$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
plot(train2$Date2,train2$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()